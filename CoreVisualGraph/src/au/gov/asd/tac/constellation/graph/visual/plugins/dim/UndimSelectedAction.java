...
/**
 * un-dim selected elements
 *
 * @author algol
 */
@ActionID(category = "Selection", id = "au.gov.asd.tac.constellation.functionality.dim.UndimSelectedAction")
@ActionRegistration(displayName = "#CTL_UndimSelectedAction", iconBase = "au/gov/asd/tac/constellation/graph/visual/plugins/dim/resources/undim_selected.png", surviveFocusChange = true)
...
public final class UndimSelectedAction extends SimplePluginAction {
    ...
    public UndimSelectedAction(final GraphNode context) {
        super(context, VisualGraphPluginRegistry.UNDIM_SELECTED);
    }
}
