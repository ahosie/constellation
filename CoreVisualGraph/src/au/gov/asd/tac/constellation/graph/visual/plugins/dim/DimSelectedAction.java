...
@ActionRegistration(displayName = "#CTL_DimSelectedAction", iconBase = "au/gov/asd/tac/constellation/graph/visual/plugins/dim/resources/dim_selected.png", surviveFocusChange = true)
...
public final class DimSelectedAction extends SimplePluginAction {
    ...
    public DimSelectedAction(final GraphNode context) {
        super(context, VisualGraphPluginRegistry.DIM_SELECTED);
    }
}
