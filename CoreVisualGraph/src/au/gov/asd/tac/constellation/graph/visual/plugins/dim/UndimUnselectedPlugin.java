...
/**
 * plugin framework for undim unselected elements
 *
 * @author algol
 */
@ServiceProvider(service = Plugin.class)
@Messages("UndimUnselectedPlugin=Undim Unselected")
public class UndimUnselectedPlugin extends SimpleEditPlugin {
