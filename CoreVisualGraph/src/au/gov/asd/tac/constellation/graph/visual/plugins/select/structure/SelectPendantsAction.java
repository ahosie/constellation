...
@ActionRegistration(displayName = "#CTL_SelectPendantsAction", iconBase = "au/gov/asd/tac/constellation/graph/visual/plugins/select/structure/resources/pendant.png", surviveFocusChange = true)
@ActionReferences({
...
public final class SelectPendantsAction extends SimplePluginAction {
    ...
    public SelectPendantsAction(final GraphNode context) {
        super(context, VisualGraphPluginRegistry.SELECT_PENDANTS);
    }
}
