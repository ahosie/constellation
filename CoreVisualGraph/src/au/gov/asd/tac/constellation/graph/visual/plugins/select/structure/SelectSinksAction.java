...
@ActionRegistration(displayName = "#CTL_SelectSinksAction", iconBase = "au/gov/asd/tac/constellation/graph/visual/plugins/select/structure/resources/sink.png", surviveFocusChange = true)
@ActionReferences({
...
public class SelectSinksAction extends SimplePluginAction {
    ...
    public SelectSinksAction(final GraphNode context) {
        super(context, VisualGraphPluginRegistry.SELECT_SINKS);
    }
}
