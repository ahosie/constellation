...
public class MergeNodeNGTest {
    ...
    public void setUpMethod() throws Exception {
        ...
        try {
            ...
            vAttrId = wg.addAttribute(GraphElementType.VERTEX, "boolean", "selected", "selected", false, null);
            if (vAttrId == Graph.NOT_FOUND) {
                fail();
            }

            tAttrId = wg.addAttribute(GraphElementType.TRANSACTION, "boolean", "selected", "selected", false, null);
