...
public class HopHalfNGTest {
    ...
    @Test
    public void singleHopTest() throws InterruptedException, PluginException {
        graph.setBooleanValue(vAttrId, vxId2, true);
        graph.setBooleanValue(vAttrId, vxId5, true);
        graph.setBooleanValue(vAttrId, vxId7, true);

        assertFalse(String.format("Node [%d] should de-selected", vxId1), graph.getBooleanValue(vAttrId, vxId1));
        assertTrue(String.format("Node [%d] should selected", vxId2), graph.getBooleanValue(vAttrId, vxId2));
        assertFalse(String.format("Node [%d] should de-selected", vxId3), graph.getBooleanValue(vAttrId, vxId3));
        assertFalse(String.format("Node [%d] should de-selected", vxId4), graph.getBooleanValue(vAttrId, vxId4));
        assertTrue(String.format("Node [%d] should selected", vxId5), graph.getBooleanValue(vAttrId, vxId5));
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(vAttrId, vxId6));
        assertTrue(String.format("Node [%d] should selected", vxId7), graph.getBooleanValue(vAttrId, vxId7));
        assertFalse(String.format("Transaction [%d] should de-selected", txId1), graph.getBooleanValue(tAttrId, txId1));
        assertFalse(String.format("Transaction [%d] should de-selected", txId2), graph.getBooleanValue(tAttrId, txId2));
        assertFalse(String.format("Transaction [%d] should de-selected", txId3), graph.getBooleanValue(tAttrId, txId3));
        assertFalse(String.format("Transaction [%d] should de-selected", txId4), graph.getBooleanValue(tAttrId, txId4));
        assertFalse(String.format("Transaction [%d] should de-selected", txId5), graph.getBooleanValue(tAttrId, txId5));
        ...
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(vAttrId, vxId6));
        assertTrue(String.format("Node [%d] should selected", vxId7), graph.getBooleanValue(vAttrId, vxId7));
        assertTrue(String.format("Transaction [%d] should selected", txId1), graph.getBooleanValue(tAttrId, txId1));
        assertFalse(String.format("Transaction [%d] should de-selected", txId2), graph.getBooleanValue(tAttrId, txId2));
        assertTrue(String.format("Transaction [%d] should selected", txId3), graph.getBooleanValue(tAttrId, txId3));
        assertTrue(String.format("Transaction [%d] should selected", txId4), graph.getBooleanValue(tAttrId, txId4));
        assertTrue(String.format("Transaction [%d] should selected", txId5), graph.getBooleanValue(tAttrId, txId5));
    }

    @Test
    public void twoSingleHopTest() throws InterruptedException, PluginException {
        graph.setBooleanValue(vAttrId, vxId2, true);
        graph.setBooleanValue(vAttrId, vxId5, true);
        graph.setBooleanValue(vAttrId, vxId7, true);
    ...
    @Test
    public void singleHopTest2() throws InterruptedException, PluginException {
        graph.setBooleanValue(vAttrId, vxId1, true);
        graph.setBooleanValue(tAttrId, txId3, true);

        assertTrue(String.format("Node [%d] should selected", vxId1), graph.getBooleanValue(vAttrId, vxId1));
        assertFalse(String.format("Node [%d] should de-selected", vxId2), graph.getBooleanValue(vAttrId, vxId2));
        assertFalse(String.format("Node [%d] should de-selected", vxId3), graph.getBooleanValue(vAttrId, vxId3));
        assertFalse(String.format("Node [%d] should de-selected", vxId4), graph.getBooleanValue(vAttrId, vxId4));
        assertFalse(String.format("Node [%d] should de-selected", vxId5), graph.getBooleanValue(vAttrId, vxId5));
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(vAttrId, vxId6));
        assertFalse(String.format("Node [%d] should de-selected", vxId7), graph.getBooleanValue(vAttrId, vxId7));
        assertFalse(String.format("Transaction [%d] should de-selected", txId1), graph.getBooleanValue(tAttrId, txId1));
        assertFalse(String.format("Transaction [%d] should de-selected", txId2), graph.getBooleanValue(tAttrId, txId2));
        assertTrue(String.format("Transaction [%d] should selected", txId3), graph.getBooleanValue(tAttrId, txId3));
        assertFalse(String.format("Transaction [%d] should de-selected", txId4), graph.getBooleanValue(tAttrId, txId4));
        ...
        assertTrue(String.format("Node [%d] should selected", vxId2), graph.getBooleanValue(vAttrId, vxId2));
        assertFalse(String.format("Node [%d] should de-selected", vxId3), graph.getBooleanValue(vAttrId, vxId3));
        assertTrue(String.format("Node [%d] should selected", vxId4), graph.getBooleanValue(vAttrId, vxId4));
        assertFalse(String.format("Node [%d] should de-selected", vxId5), graph.getBooleanValue(vAttrId, vxId5));
        assertFalse(String.format("Node [%d] should de-selected", vxId6), graph.getBooleanValue(vAttrId, vxId6));
        assertFalse(String.format("Node [%d] should de-selected", vxId7), graph.getBooleanValue(vAttrId, vxId7));
        assertTrue(String.format("Transaction [%d] should selected", txId1), graph.getBooleanValue(tAttrId, txId1));
        assertTrue(String.format("Transaction [%d] should selected", txId2), graph.getBooleanValue(tAttrId, txId2));
        assertTrue(String.format("Transaction [%d] should selected", txId3), graph.getBooleanValue(tAttrId, txId3));
        assertFalse(String.format("Transaction [%d] should de-selected", txId4), graph.getBooleanValue(tAttrId, txId4));
        assertFalse(String.format("Transaction [%d] should de-selected", txId5), graph.getBooleanValue(tAttrId, txId5));
    }
