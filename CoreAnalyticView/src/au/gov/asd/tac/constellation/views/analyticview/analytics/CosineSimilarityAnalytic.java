...
/**
 * The Cosine Similarity analytic for the Analytic View.
 *
 * @author cygnus_x-1
 */
@ServiceProviders({
...
@NbBundle.Messages("CosineSimilarityAnalytic=Cosine Similarity Analytic")
public class CosineSimilarityAnalytic extends ScoreAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-cosine-similarity.html";
    }
    ...
    public Set<SchemaAttribute> getAnalyticAttributes(final PluginParameters parameters) {
        ...
        analyticAttributes.add(SnaConcept.TransactionAttribute.COSINE_SIMILARITY);
        return Collections.unmodifiableSet(analyticAttributes);
    }

    @Override
    public Class<? extends Plugin> getAnalyticPlugin() {
        return CosineSimilarityPlugin.class;
    }
}
