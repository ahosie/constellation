...
/**
 * The Eccentricity analytic for the Analytic View.
 *
 * @author cygnus_x-1
 */
@ServiceProviders({
...
@NbBundle.Messages("EccentricityAnalytic=Eccentricity Analytic")
public class EccentricityAnalytic extends ScoreAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-eccentricity.html";
    }
