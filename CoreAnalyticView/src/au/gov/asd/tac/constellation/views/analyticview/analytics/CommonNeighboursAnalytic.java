...
/**
 * The Common Neighbours analytic for the Analytic View.
 *
...
@NbBundle.Messages("CommonNeighboursAnalytic=Common Neighbours Analytic")
public class CommonNeighboursAnalytic extends ScoreAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-common-neighbours.html";
    }
    ...
    public Set<SchemaAttribute> getAnalyticAttributes(final PluginParameters parameters) {
        ...
        analyticAttributes.add(SnaConcept.TransactionAttribute.COMMON_NEIGHBOURS);
    ...
    public Class<? extends Plugin> getAnalyticPlugin() {
        return CommonNeighboursPlugin.class;
    }
}
