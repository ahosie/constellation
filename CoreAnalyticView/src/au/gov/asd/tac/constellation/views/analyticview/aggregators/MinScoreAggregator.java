 ...
 * @author cygnus_x-1
 */
@ServiceProvider(service = AnalyticAggregator.class, position = 30)
public class MinScoreAggregator implements AnalyticAggregator<ScoreResult> {

    private static final String SCORE_NAME = "Min Score";
