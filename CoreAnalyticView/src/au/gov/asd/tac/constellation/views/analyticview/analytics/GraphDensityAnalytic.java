...
/**
 * The global graph density analytic for the Analytic View.
 *
...
@NbBundle.Messages("GraphDensityAnalytic=Graph Density Analytic")
public class GraphDensityAnalytic extends GraphAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-graph-density.html";
    }
    ...
    public Set<SchemaAttribute> getAnalyticAttributes(final PluginParameters parameters) {
        ...
        attributes.add(SnaConcept.GraphAttribute.DENSITY);
        return Collections.unmodifiableSet(attributes);
    }

    @Override
    public Class<? extends Plugin> getAnalyticPlugin() {
        return GraphDensityPlugin.class;
    }
}
