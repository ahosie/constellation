...
import au.gov.asd.tac.constellation.views.analyticview.analytics.BetweennessCentralityAnalytic;
...
public class BestConnectsNetworkQuestion implements AnalyticQuestionDescription<ScoreResult> {

    @Override
    public String getName() {
        return "Connects the Network Best?";
    }
    ...
    public List<Class<? extends AnalyticPlugin<ScoreResult>>> getPluginClasses() {
        return Arrays.asList(BetweennessCentralityAnalytic.class);
    }
    ...
    public void initialiseParameters(final AnalyticPlugin<ScoreResult> plugin, final PluginParameters parameters) {
        ...
        parameters.setBooleanValue(BetweennessCentralityPlugin.NORMALISE_POSSIBLE_PARAMETER_ID, true);
