...
/**
 * The Jaccard Index analytic for the Analytic View.
 *
 * @author cygnus_x-1
 */
@ServiceProviders({
...
@NbBundle.Messages("JaccardIndexAnalytic=Jaccard Index Analytic")
public class JaccardIndexAnalytic extends ScoreAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-jaccard-index.html";
    }
    ...
    public Set<SchemaAttribute> getAnalyticAttributes(final PluginParameters parameters) {
        ...
        analyticAttributes.add(SnaConcept.TransactionAttribute.JACCARD_INDEX);
        return Collections.unmodifiableSet(analyticAttributes);
    }

    @Override
    public Class<? extends Plugin> getAnalyticPlugin() {
        return JaccardIndexPlugin.class;
    }
}
