...
/**
 * The Adamic-Adar Index analytic for the Analytic View.
 *
...
@NbBundle.Messages("AdamicAdarIndexAnalytic=Adamic-Adar Index Analytic")
public class AdamicAdarIndexAnalytic extends ScoreAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-adamic-adar-index.html";
    }
    ...
    public Set<SchemaAttribute> getAnalyticAttributes(final PluginParameters parameters) {
        ...
        analyticAttributes.add(SnaConcept.TransactionAttribute.ADAMIC_ADAR_INDEX);
        return Collections.unmodifiableSet(analyticAttributes);
    }

    @Override
    public Class<? extends Plugin> getAnalyticPlugin() {
        return AdamicAdarIndexPlugin.class;
    }
}
