...
/**
 * The Ratio of Reciprocity analytic for the Analytic View.
 *
 * @author cygnus_x-1
 */
@ServiceProviders({
...
@NbBundle.Messages("RatioOfReciprocityAnalytic=Ratio of Reciprocity Analytic")
public class RatioOfReciprocityAnalytic extends ScoreAnalyticPlugin {

    @Override
    public String getDocumentationUrl() {
        return "nbdocs://au.gov.asd.tac.constellation.views.analyticview/au/gov/asd/tac/constellation/views/analyticview/docs/analyticview-analytic-ratio-of-reciprocity.html";
    }
    ...
    public Set<SchemaAttribute> getAnalyticAttributes(final PluginParameters parameters) {
        ...
        analyticAttributes.add(SnaConcept.TransactionAttribute.RATIO_OF_RECIPROCITY);
        return Collections.unmodifiableSet(analyticAttributes);
    }

    @Override
    public Class<? extends Plugin> getAnalyticPlugin() {
        return RatioOfReciprocityPlugin.class;
    }
}
