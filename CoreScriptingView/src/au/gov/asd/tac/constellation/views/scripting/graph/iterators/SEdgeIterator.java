 ...
 * @author cygnus_x-1
 */
public class SEdgeIterator implements Iterator<SEdge> {

    private final GraphReadMethods readableGraph;
    private final int edgeCount;
    private int currentPosition;

    public SEdgeIterator(final GraphReadMethods readableGraph) {
        this.readableGraph = readableGraph;
        this.edgeCount = readableGraph.getEdgeCount();
    ...
    public SEdge next() {
        ...
        final int transactionId = readableGraph.getEdge(currentPosition++);
