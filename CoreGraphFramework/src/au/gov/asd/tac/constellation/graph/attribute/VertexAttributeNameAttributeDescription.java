...
public final class VertexAttributeNameAttributeDescription extends AbstractObjectAttributeDescription<String> {

    public static final String ATTRIBUTE_NAME = "vertex_attribute_name";
    public static final Class<String> NATIVE_CLASS = String.class;
    private static final String DEFAULT_VALUE = null;

    public VertexAttributeNameAttributeDescription() {
