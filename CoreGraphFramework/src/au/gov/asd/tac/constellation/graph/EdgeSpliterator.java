 ...
 * @author algol
 */
public class EdgeSpliterator implements Spliterator.OfInt {

    private final GraphReadMethods rg;
    private int position;
    private int limit;

    public EdgeSpliterator(final GraphReadMethods rg) {
        this.rg = rg;
        position = 0;
        limit = rg.getEdgeCount();
    }

    private EdgeSpliterator(final GraphReadMethods rg, final int position, final int limit) {
        this.rg = rg;
    ...
    public OfInt trySplit() {
        ...
        return new EdgeSpliterator(rg, limit, oldLimit);
    }
