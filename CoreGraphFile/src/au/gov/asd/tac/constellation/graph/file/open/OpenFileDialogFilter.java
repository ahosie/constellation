 ...
 *     ...
 * }
 * </pre> Note, if you plan to implement the service provider as a nested class
 * then it should be <i>static nested class</i>, not an <i>inner class</i>.
 * <p>
 ...
 * <p>
 * <b>Note:</b><br>
 * If behavior of the file filter should be exactly the same as implemented by
 * the {@link FileNameExtensionFilter } class then, please use the class
 * {@link OpenFileDialogFilter.ExtensionFilter } instead.
 * <p>
 *
...
public abstract class OpenFileDialogFilter extends FileFilter {
     ...
     * {@code compareSuffixes(String fileName, String suffix)}.
     * <p>
     *
     * @param file the file under test.
     * @return  <code>true</code> if the file's name ends with one of the strings
     * specified by the constructor or if the file is a * directory,
     ...
     * <p>
     * Default implementation of this method compares <code>fileName</code> to
     * <code>suffix</code>, ignoring case considerations. The
     * <code>fileName</code> and the <code>suffix</code> are considered equal
     * ignoring case if <code>fileName</code> ends with <code>suffix</code> and
     * corresponding characters in the suffix part are equal ignoring case.
     * <br>
     ...
     * <code>suffix</code>, otherwise <code>true</code>.
     */
    public boolean compareSuffixes(final String fileName, final String suffix) {
        return fileName.toUpperCase().endsWith(suffix.toUpperCase());
    }

    /**
     * Returns a formatted string containing both the filter description and the
     * list of applicable file name suffixes associated with this filter.
     *
     * <p>
     * Note, it is final method. To define the filter description a successor
     * class should override the method {@link #getDescriptionString() }. </p>
     *
     ...
     * }
     * </pre> where "OFDFD_XFiles" is a name of the Open File Dialog Filter
     * Description (<b>OFDFD</b>) property defined in a resource bundle file
     * (e.g. {@code Bundle.properties}) suitable for internationalizing.
     *
     * <p>
     ...
     * add this to the description in the uniform manner, i.e. the OFDFD should
     * define
     * <pre>Java Files</pre> but not something like
     * <pre>Java Files (*.java)</pre>
     * <p>
     *
     * @return a non-null description string of the file filter without a list
     * of suffixes/extensions.
     */
     ...
     *
     * @return an array of the non-null strings that contains file name
     * suffixes.
     */
    public abstract String[] getSuffixes();

    /**
     * Returns a string representation of the {@code OpenFileDialogFilter}. This
     * method is intended to be used for debugging purposes, and the content and
     ...
     * intended to be used as a service provider. This implementation wraps an
     * instance of the {@link FileNameExtensionFilter } class.
     *
     * <p>
     * <b>Example:</b>
     * <pre>
