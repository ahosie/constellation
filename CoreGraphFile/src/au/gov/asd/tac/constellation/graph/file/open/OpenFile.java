...
public final class OpenFile {
     ...
     * @param line the line number to read to.
    ...
    /**
     * Checks whether the specified file exists. If the file doesn't exists,
     * displays a message.
     * <p>
     * The code for displaying the message is running in a separate thread so
     * that it does not block the current thread.
     *
     * @param file file to check for existence
     * @return null on success, otherwise the error message
     */
    private static String checkFileExists(final File file) {
