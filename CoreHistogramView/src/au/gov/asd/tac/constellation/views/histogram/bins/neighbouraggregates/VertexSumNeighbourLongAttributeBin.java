...
/**
 * A bin that holds long values representing the sum of all neighbour values
 * adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexSumNeighbourLongAttributeBin extends LongBin {
    ...
    @Override
    public Bin create() {
        return new VertexSumNeighbourLongAttributeBin();
    }
}
