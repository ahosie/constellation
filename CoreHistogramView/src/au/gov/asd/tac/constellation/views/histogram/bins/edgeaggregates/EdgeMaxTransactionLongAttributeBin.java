...
/**
 * A bin that holds long values representing the maximum of all transaction
 * values under a single edge.
 *
 * @author sirius
 */
public class EdgeMaxTransactionLongAttributeBin extends LongBin {
    ...
    @Override
    public Bin create() {
        return new EdgeMaxTransactionLongAttributeBin();
    }
}
