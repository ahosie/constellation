...
/**
 * A bin that holds double values representing the maximum of all neighbour
 * values adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexMaxNeighbourDoubleAttributeBin extends DoubleBin {
    ...
    @Override
    public Bin create() {
        return new VertexMaxNeighbourDoubleAttributeBin();
    }
}
