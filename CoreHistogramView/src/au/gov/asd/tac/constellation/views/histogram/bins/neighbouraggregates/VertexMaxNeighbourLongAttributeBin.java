...
/**
 * A bin that holds long values representing the maximum of all neighbour values
 * adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexMaxNeighbourLongAttributeBin extends LongBin {
    ...
    @Override
    public Bin create() {
        return new VertexMaxNeighbourLongAttributeBin();
    }
}
