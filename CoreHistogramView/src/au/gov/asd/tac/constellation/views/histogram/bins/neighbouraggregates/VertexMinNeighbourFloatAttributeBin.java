...
/**
 * A bin that holds float values representing the minimum of all neighbour
 * values adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexMinNeighbourFloatAttributeBin extends FloatBin {
    ...
    @Override
    public Bin create() {
        return new VertexMinNeighbourFloatAttributeBin();
    }
}
