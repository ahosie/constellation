...
/**
 * A bin that holds float values representing the sum of all transaction values
 * under a single link.
 *
 * @author sirius
 */
public class LinkSumTransactionFloatAttributeBin extends FloatBin {
    ...
    @Override
    public Bin create() {
        return new LinkSumTransactionFloatAttributeBin();
    }
}
