...
/**
 * A bin that holds double values representing the sum of all neighbour values
 * adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexSumNeighbourDoubleAttributeBin extends DoubleBin {
    ...
    @Override
    public Bin create() {
        return new VertexSumNeighbourDoubleAttributeBin();
    }
}
