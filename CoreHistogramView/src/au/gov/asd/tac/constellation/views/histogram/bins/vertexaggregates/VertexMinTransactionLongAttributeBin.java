...
/**
 * A bin that holds long values representing the minimum of all transaction
 * values adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexMinTransactionLongAttributeBin extends LongBin {
    ...
    @Override
    public Bin create() {
        return new VertexMinTransactionLongAttributeBin();
    }
}
