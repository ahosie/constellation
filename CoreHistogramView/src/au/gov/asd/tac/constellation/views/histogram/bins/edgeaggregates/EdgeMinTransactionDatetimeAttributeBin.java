 ...
 * @author sirius
 */
public class EdgeMinTransactionDatetimeAttributeBin extends DateTimeBin {

    public EdgeMinTransactionDatetimeAttributeBin() {
    }

    public EdgeMinTransactionDatetimeAttributeBin(DateTimeFormatter formatter) {
        super(formatter);
    }
    ...
    @Override
    public Bin create() {
        return new EdgeMinTransactionDatetimeAttributeBin(formatter);
    }
}
