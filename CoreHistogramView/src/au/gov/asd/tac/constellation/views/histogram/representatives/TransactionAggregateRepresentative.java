...
/**
 * An ElementRepresentative specially designed to allow aggregate functions over
 * transaction attributes as they apply to groups of transactions under links or
 * edges.
 *
 * @author sirius
 */
public class TransactionAggregateRepresentative extends ElementRepresentative {

    @Override
    public int appliesToElementType(GraphElementType elementType) {
        return elementType == GraphElementType.LINK || elementType == GraphElementType.EDGE ? 1 : -1;
    }
