...
public class DateTimeDateFormatter extends BinFormatter {
    ...
    private class DateTimeDateBin extends ObjectBin {
        ...
        public void setKey(GraphReadMethods graph, int attribute, int element) {
            ...
            key = bin.getKeyAsObject() == null ? null : ((ZonedDateTime) bin.getKeyAsObject()).toLocalDate();
        }

        @Override
        public void prepareForPresentation() {
            label = key == null ? null : formatter.format((LocalDate) key);
        }
