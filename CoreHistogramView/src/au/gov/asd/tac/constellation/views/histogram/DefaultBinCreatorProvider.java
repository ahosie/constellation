...
public class DefaultBinCreatorProvider extends AttributeBinCreatorProvider {
    ...
    public void register() {
        ...
        AttributeType.ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.INT_ATTRIBUTE_BIN_CREATOR);
        AttributeType.ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.INT_ATTRIBUTE_BIN_CREATOR);
        ...
        AttributeType.ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.DOUBLE_ATTRIBUTE_BIN_CREATOR);
        ...
        AttributeType.SOURCE_VERTEX_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.SOURCE_INT_ATTRIBUTE_BIN_CREATOR);
        AttributeType.SOURCE_VERTEX_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.SOURCE_INT_ATTRIBUTE_BIN_CREATOR);
        ...
        AttributeType.SOURCE_VERTEX_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.SOURCE_DOUBLE_ATTRIBUTE_BIN_CREATOR);
        ...
        AttributeType.DESTINATION_VERTEX_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.DESTINATION_INT_ATTRIBUTE_BIN_CREATOR);
        AttributeType.DESTINATION_VERTEX_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.DESTINATION_INT_ATTRIBUTE_BIN_CREATOR);
        ...
        AttributeType.DESTINATION_VERTEX_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.DESTINATION_DOUBLE_ATTRIBUTE_BIN_CREATOR);
        ...
        AttributeType.LINK_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.LINK_TRANSACTION_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.LINK_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.LINK_TRANSACTION_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.LINK_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.LINK_TRANSACTION_SUM_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.LINK_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.LINK_TRANSACTION_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.LINK_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.LINK_TRANSACTION_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.LINK_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.LINK_TRANSACTION_AVERAGE_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.LINK_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.LINK_TRANSACTION_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.LINK_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.LINK_TRANSACTION_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.LINK_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.LINK_TRANSACTION_MAX_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.LINK_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.LINK_TRANSACTION_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.LINK_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.LINK_TRANSACTION_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.LINK_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.LINK_TRANSACTION_MIN_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.EDGE_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.EDGE_TRANSACTION_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.EDGE_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.EDGE_TRANSACTION_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.EDGE_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.EDGE_TRANSACTION_SUM_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.EDGE_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.EDGE_TRANSACTION_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.EDGE_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.EDGE_TRANSACTION_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.EDGE_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.EDGE_TRANSACTION_AVERAGE_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.EDGE_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.EDGE_TRANSACTION_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.EDGE_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.EDGE_TRANSACTION_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.EDGE_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.EDGE_TRANSACTION_MAX_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.EDGE_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.EDGE_TRANSACTION_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.EDGE_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.EDGE_TRANSACTION_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.EDGE_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.EDGE_TRANSACTION_MIN_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_TRANSACTION_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_TRANSACTION_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_SUM_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_TRANSACTION_SUM_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.VERTEX_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_TRANSACTION_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_TRANSACTION_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_AVERAGE_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_TRANSACTION_AVERAGE_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.VERTEX_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_TRANSACTION_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_TRANSACTION_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_MAX_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_TRANSACTION_MAX_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_TRANSACTION_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_TRANSACTION_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_MIN_TRANSACTION_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_TRANSACTION_MIN_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_SUM_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_NEIGHBOUR_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_SUM_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_NEIGHBOUR_SUM_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_SUM_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_NEIGHBOUR_SUM_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.VERTEX_AVERAGE_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_NEIGHBOUR_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_AVERAGE_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_NEIGHBOUR_AVERAGE_FLOAT_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_AVERAGE_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_NEIGHBOUR_AVERAGE_DOUBLE_ATTRIBUTE_BIN_PROVIDER);

        AttributeType.VERTEX_MAX_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_NEIGHBOUR_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_MAX_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_NEIGHBOUR_MAX_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_MAX_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_NEIGHBOUR_MAX_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_MIN_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("byte", DefaultBinCreators.VERTEX_NEIGHBOUR_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        AttributeType.VERTEX_MIN_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("short", DefaultBinCreators.VERTEX_NEIGHBOUR_MIN_LONG_ATTRIBUTE_BIN_PROVIDER);
        ...
        AttributeType.VERTEX_MIN_NEIGHBOUR_ATTRIBUTE.registerAttributeBinCreator("double", DefaultBinCreators.VERTEX_NEIGHBOUR_MIN_DOUBLE_ATTRIBUTE_BIN_PROVIDER);
