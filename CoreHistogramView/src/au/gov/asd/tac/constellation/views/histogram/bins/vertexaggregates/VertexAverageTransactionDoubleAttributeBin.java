...
/**
 * A bin that holds double values representing the average of all transaction
 * values adjacent to a single vertex.
 *
 * @author sirius
 */
public class VertexAverageTransactionDoubleAttributeBin extends DoubleBin {
    ...
    @Override
    public Bin create() {
        return new VertexAverageTransactionDoubleAttributeBin();
    }
}
