 ...
 * @author cygnus_x-1
 */
@ActionID(category = "Similarity", id = "au.gov.asd.tac.constellation.plugins.algorithms.sna.similarity.CosineSimilarityAction")
@ActionRegistration(displayName = "#CTL_CosineSimilarityAction")
@NbBundle.Messages("CTL_CosineSimilarityAction=Cosine Similarity")
public class CosineSimilarityAction implements ActionListener {

    private final GraphNode context;

    public CosineSimilarityAction(final GraphNode context) {
        this.context = context;
    }

    @Override
    public void actionPerformed(final ActionEvent ev) {
        PluginExecution.withPlugin(AlgorithmPluginRegistry.COSINE_SIMILARITY)
