...
/**
 * Global Components Count Plugin Test.
 *
 * @author canis_majoris
 */
public class ComponentsCountNGTest {
    ...
    public void testAverageDegree() throws Exception {
        final ComponentCountPlugin instance = new ComponentCountPlugin();
        final PluginParameters parameters = instance.createParameters();
        PluginExecution.withPlugin(instance).withParameters(parameters).executeNow(graph);

        assertEquals(graph.getFloatValue(graphAttribute, 0), 3f);
    }
}
