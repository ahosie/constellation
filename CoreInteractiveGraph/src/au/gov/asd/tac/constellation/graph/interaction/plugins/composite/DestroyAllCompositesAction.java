...
/**
 * Action for destroying all composites. It is accessed from the tools menu.
 *
 * @see DestroyAllCompositesPlugin
...
public class DestroyAllCompositesAction extends SimplePluginAction {
    ...
    public DestroyAllCompositesAction(final GraphNode context) {
        super(context, InteractiveGraphPluginRegistry.DESTROY_ALL_COMPOSITES);
    }
}
