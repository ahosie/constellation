...
@ActionRegistration(displayName = "#CTL_CopyToNewGraphAction", iconBase = "au/gov/asd/tac/constellation/graph/interaction/plugins/clipboard/resources/copy_to_new_graph.png", surviveFocusChange = true)
@ActionReferences({
