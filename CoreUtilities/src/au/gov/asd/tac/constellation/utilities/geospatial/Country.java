...
public enum Country {
    ...
    ALGERIA("DZ", "DZA", null, "Algerian", "Algeria"),
    AMERICAN_SAMOA("AS", "ASM", null, "American Samoan", "American Samoa"),
    ANDORRA("AD", "AND", null, "Andorran", "Andorra"),
    ANGOLA("AO", "AGO", null, "Angolan", "Angola"),
    ANGUILLA("AI", "AIA", null, "Anguillan", "Anguilla"),
    ...
    BAHAMAS("BS", "BHS", "Bahamian", "Bahamas"),
    ...
    CURACAO("CW", "CUW", null, "Curaçao"),
    CYPRUS("CY", "CYP", "Cypriot", "Cyprus"),
    CZECH_REPUBLIC("CZ", "CZE", "Czech", "Czech Republic"),
    ...
    MACEDONIA("MK", "MKD", "Macedonian", "Macedonia", "The Former Yugoslav Republic of Macedonia"),
    ...
    NETHERLANDS("NL", "NLD", "Dutch", "Netherlands"),
    ...
    PHILIPPINES("PH", "PHL", "Philippine", "Philippines"),
    ...
    UNITED_STATES("US", "USA", "American", "United States", "United States of America"),
